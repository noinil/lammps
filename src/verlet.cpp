...
void Verlet::setup()
{
  ...
  std::ofstream forces_all("n_force_all.dat");
  std::ofstream forces_non("n_force_nonlocal.dat");
  // ==================================================
